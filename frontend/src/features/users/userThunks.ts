...
import {GlobalError, LoginMutation, RegisterMutation, RegisterResponse, UserFields, ValidationError} from "../../types";
...
export const googleLogin = createAsyncThunk<UserFields, string, { rejectValue: GlobalError }>(
    'users/googleLogin',
